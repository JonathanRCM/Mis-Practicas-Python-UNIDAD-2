...
conexion.execute("Insert into alumnos(nombre,edad) values(?,?)", ("Jonathan", 18))
conexion.execute("Insert into alumnos(nombre,edad) values(?,?)", ("Ligia", 42))
...
alumno = conexion.execute("select * from alumnos where nombre = 'Jonathan'")
